...
// // not related to game
// // ... represents rest operator, and it should be at the end of the parameters' list
// // you cannot have more than one rest operator (...)  
...
// //if you use function key word, you will have permission to use arguments instead of rest operator(...) and numbers[]
...
// // console.log(sumUp(1,5,10,-3,6,10,25,88));
// // subtractUp(showResult,1,5,10,-3,6,10,25,88);
// combine(showResult.bind(this,'The result after adding all numbers is:'),'ADD',1,5,10,-3,6,10,25,88);
// combine(showResult.bind(this, 'The result after subtracting all numbers is:'), 'SUBTRACT', 10, -3, 6, 10, 25, 88);